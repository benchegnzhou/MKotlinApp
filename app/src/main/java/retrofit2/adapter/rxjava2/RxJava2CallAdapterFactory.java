...
public final class RxJava2CallAdapterFactory extends CallAdapter.Factory {
    ...
    public static RxJava2CallAdapterFactory createWithScheduler(Scheduler subscribeOnScheduler) {
        if (subscribeOnScheduler == null)
            throw new NullPointerException("subscribeOnScheduler == null");
        return new RxJava2CallAdapterFactory(subscribeOnScheduler, null, false);
    }

    public static RxJava2CallAdapterFactory createWithSchedulers(Scheduler subscribeOnScheduler, Scheduler observeOnScheduler) {
        if (subscribeOnScheduler == null)
            throw new NullPointerException("subscribeOnScheduler == null");
        if (observeOnScheduler == null)
            throw new NullPointerException("observeOnScheduler == null");
        return new RxJava2CallAdapterFactory(subscribeOnScheduler, observeOnScheduler, false);
    }
    ...
    private RxJava2CallAdapterFactory(@Nullable Scheduler subscribeOnScheduler, @Nullable Scheduler observeOnScheduler, boolean isAsync) {
    ...
    CallAdapter<?, ?> get(
        ...
        if (rawType == Completable.class) {
            ...
            return new RxJava2CallAdapter(
                    Void.class, subscribeOnScheduler, observeOnScheduler, isAsync, false, true, false, false, false, true);
        }
        ...
        return new RxJava2CallAdapter(
                responseType, subscribeOnScheduler, observeOnScheduler, isAsync, isResult, isBody, isFlowable, isSingle, isMaybe, false);
    }
}
